                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form
                                        ...
                                        className='my-10'>
                                        <div className='mb-5'>
                                            <label className='text-gray-700 text-sm uppercase' htmlFor='nombre'>Nombre Tarea</label>
                                            <input type="text" id="nombre" placeholder='Nombre Tarea'
                                        ...
                                        <div className='mb-5'>
                                            <label className='text-gray-700 text-sm uppercase' htmlFor='descripcion'>Descripción Tarea</label>
                                            <textarea id="descripcion" placeholder='Descripción Tarea'
                                                className='border-2 w-full p-2 mt-2 placeholder:gray-400 rounded-md'
                                                value={descripcion}
                                        ...
                                        <div className='mb-5'>
                                            <label className='text-gray-700 text-sm uppercase' htmlFor='fecha-entrega'>Fecha Entrega</label>
                                        ...
                                        <div className='mb-5'>
                                            <label className='text-gray-700 text-sm uppercase' htmlFor='prioridad'>Prioridad</label>
                                            <select id="prioridad"
                                                className='border-2 w-full p-2 mt-2 placeholder:gray-400 rounded-md'
                                                value={prioridad}
